        ...
        <DetailsCard
          timeline={
            <span className='flex flex-col gap-1'>
              <span>8 sessions. May - September 2025. Thursdays @ 4:30-6PM GMT.</span>
			  <span className='font-medium'>May 1 ✧ May 22 ✧ Jun 12 ✧ Jul 3 ✧ Jul 24 ✧ Aug 14 ✧ Sep 4 ✧ Sep 25</span>
            </span>
          }
