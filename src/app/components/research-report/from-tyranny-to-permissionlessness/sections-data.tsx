      ...
      <div className="max-w-3xl min-h-[200px] flex items-center text-base">
        <div>
          ...
          <List>
            ...
            <ListItem><strong>Develop transition pathways:</strong> fund alumni roles (mentorship, documentation, part-time maintenance). </ListItem>
          </List>
        </div>
      </div>
    ),
