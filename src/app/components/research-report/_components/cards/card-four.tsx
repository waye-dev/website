...
export const CardFour = ({ isExpanded, onLabelClick, onScroll, position, isInteracted }: CardProps) => {
    const leftPosition = isInteracted ? `calc(${position * 22}% - ${position * .6}rem)` : `calc(${position * 22}% - ${position * 1.5}rem)`
    ...
    return (
        <div className={`absolute origin-bottom w-full transition-transform duration-500 ease-in-out pointer-events-none ${
            ...
            <div className="relative h-full w-full">
                <span className="relative top-0 left-[240px] cursor-pointer pointer-events-auto" style={{ left: leftPosition }} onClick={onLabelClick}>
                ...
                <div className="w-full  bg-[#c4def8] p-[3rem] overflow-hidden pointer-events-auto">
