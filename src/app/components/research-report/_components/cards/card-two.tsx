...
export const CardTwo = ({ isExpanded, onLabelClick, onScroll, position, isInteracted }: CardProps) => {
    ...
    return (
        <div className={`absolute origin-bottom w-full transition-transform duration-500 ease-in-out pointer-events-none ${
            ...
            <div className="relative h-full w-full">
                ...
                <div className="w-full rounded-tr-[1rem] bg-white p-[3rem] overflow-hidden pointer-events-auto">
